...
- `set_paragraph_style` targets an ordinary direct body paragraph through `TextTarget` and
  assigns or clears its direct paragraph style by exact existing display name.
