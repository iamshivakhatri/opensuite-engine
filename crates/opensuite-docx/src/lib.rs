...
pub use mutation::{
    ...
    replace_picture, replace_text, replace_text_to_vec, set_content_control_text,
    set_header_footer_text, set_header_footer_text_to_vec, set_hyperlink_to_vec, set_page_number,
    set_page_number_to_vec, set_page_setup, set_page_setup_to_vec, set_paragraph_formatting,
