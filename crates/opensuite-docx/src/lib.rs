...
pub use execution::{
    DocxExecutionResult, execute_docx_insert_paragraph, execute_docx_insert_table_column,
    execute_docx_insert_table_row, execute_docx_insert_table_rows, execute_docx_replace_text,
    execute_docx_set_table_cells_text, find_docx_text, inspect_docx, inspect_docx_context,
};
...
pub use mutation::{
    delete_paragraph, insert_paragraph_after, insert_paragraph_to_vec,
