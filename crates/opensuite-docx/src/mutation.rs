...
use opensuite_protocol::{
    ...
    PageOrientation, PaperSize, ParagraphFormattingPatch, ParagraphListKind, ParagraphPlacement,
    PropertyPatch, ReplacePicture, ReplaceText, SetContentControlText, SetHyperlink, SetPageSetup,
...
mod tests {
    ...
    use opensuite_protocol::{
        ...
        PictureSizeChange, PropertyPatch, ReplaceText, SetContentControlText, SetHyperlink,
