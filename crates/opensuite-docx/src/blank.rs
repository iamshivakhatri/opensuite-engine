...
mod tests {
    ...
    fn creates_a_deterministic_valid_document_with_authoring_styles() {
        ...
        assert!(xml.contains("w:before=\"160\" w:after=\"160\""));
        assert!(xml.contains("w:line=\"276\""));
        assert!(xml.contains("w:after=\"280\""));
